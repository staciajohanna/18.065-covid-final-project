...
# get training data 
X_training = pd.read_csv("data/pc6_ev[ 0.3413183   0.25478867  0.13134266  0.10615022  0.06533687  0.05613034]_train_x.csv",header=None)
...
# get validation data
X_validation = pd.read_csv("data/pc6_ev[ 0.3413183   0.25478867  0.13134266  0.10615022  0.06533687  0.05613034]_val_x.csv",header=None)
